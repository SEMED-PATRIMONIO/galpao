...
export default function App() {
    ...
    const selecionarEvento = async (ev) => {
        ...
        try {
            ...
            // Armazena com segurança o evento em que o usuário clicou
            setEventoSelecionado(ev);

            // COMPORTAMENTO 1: Frequência finalizada (Entrada e Saída já constam no banco)
            if (data.status === 'completo') {
                dispararAlerta8Segundos(`Frequência já concluída para esta formação:\n${ev.titulo}`, 'sucesso');
                return;
            }

            // COMPORTAMENTO 2: Professor já está dentro da formação e deseja registrar a saída
            ...
            // COMPORTAMENTO PADRÃO / NENHUM: Abre a tela para confirmar a entrada da frequência
            setConteudoModal({
