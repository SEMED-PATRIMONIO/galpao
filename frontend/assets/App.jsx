...
export default function App() {
    ...
    // FUNÇÃO ANTI-FRAUDE: Cria uma assinatura fixa e imutável do hardware do aparelho
    ...
    const [deviceToken, setDeviceToken] = useState(obterFingerprintDispositivo());
...
// Definição da URL oficial do seu backend para sincronização remota
    ...
    const lidarComLimpezaGeral = () => {
        ...
        setProfessor(null);
        setDeviceToken(obterFingerprintDispositivo()); // Mantém a assinatura do hardware
