                    ...
                    <div style={{ textAlign: 'center' }}>
                        ...
                        {!fluxoSaida ? (
                            <div style={{ marginTop: 30 }}>
                                {/* MODIFICADO: Texto mudado para CONFIRMAR PRESENÇA conforme instrução */}
                                <div style={estilos.circuloRadar} onClick={dispararRegistroPresenca}>
                                    <span style={{ fontSize: 26 }}>📷</span>
                                    <span style={{ fontSize: 11, fontWeight: 'bold', marginTop: 4 }}>CONFIRMAR PRESENÇA</span>
                                </div>
                            ...
                            <div style={estilos.modalRetencao}>
                                ...
                                {/* MODIFICADO: Regra reduzida para 20 minutos no texto informativo */}
                                <p style={{ fontSize: 14, color: '#7f1d1d' }}>Você possui menos de 20 minutos registrados na atividade "{fluxoSaida.titulo}". Se sair agora, sua permanência será concluída sem cumprir o tempo total ideal. Confirma?</p>
...
const estilos = {
    ...
    circuloRadar: { width: '150px', height: '150px', borderRadius: '50%', backgroundColor: '#e0f2fe', border: '4px solid #bae6fd', color: '#0369a1', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', margin: '30px auto 0 auto', cursor: 'pointer', boxShadow: '0 10px 15px -3px rgba(3,105,161,0.2)' },
