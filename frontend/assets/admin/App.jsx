...
export default function App() {
    ...
    const carregarDadosPainel = async () => {
        try {
            setErro('');
            let endpoint = '';
            if (view === 'eventos') endpoint = '/api/v2/eventos';
    ...
    const lidarComSubmissaoForm = async (e) => {
        ...
        try {
            ...
            // CRÍTICA: Prepara os dados corretos para o envio
            let dadosParaEnviar = { ...form };

            // Se o usuário estiver salvando uma formação, busca as coordenadas do mapa na hora
            if (view === 'eventos') {
                ...
                dadosParaEnviar = {
                    ...
                    local: localSelecionado ? localSelecionado.nome : '' // Preenche também a coluna "local" caso o banco use
                };
            }

            // Envia o objeto modificado com o palestrante e geolocalização corretos
    ...
    return (
        <div style={estilos.layoutPrincipal}>
            <div style={estilos.barraLateral}>
                ...
                <div style={view === 'frequencias' ? estilos.menuItemAtivo : estilos.menuItem} onClick={() => { setView('frequencias'); setDadosEstatisticos(null); }}>Histórico</div>
            ...
            <div style={estilos.conteudoPrincipal}>
                <div style={{backgroundColor: '#fff', padding: 15, borderRadius: 8, marginBottom: 20, border: '1px solid #e2e8f0'}}>
                    <span style={{fontWeight: 'bold', textTransform: 'uppercase', fontSize: 13}}>Módulo Selecionado: {view}</span>
                ...
                {view === 'eventos' && (
                    <div style={estilos.splitLayout}>
                        ...
                        <div style={estilos.colunaDireita}>
                            ...
                            {/* MAPA EXPANDIDO, CORRIGIDO E CENTRALIZADO EM QUEIMADOS */}
                            {form.latitude && form.longitude && (
                                <div style={{ marginTop: '20px', borderRadius: '8px', overflow: 'hidden', border: '1px solid #cbd5e1' }}>
                                    <div style={{ backgroundColor: '#f8fafc', padding: '10px', fontSize: '12px', fontWeight: 'bold', color: '#0f172a', textAlign: 'left', borderBottom: '1px solid #cbd5e1' }}>
                                        📍 Localização Sincronizada no Painel
                                    </div>
                                    <iframe
...
const estilos = {
    ...
    barraLateral: { width: 250, backgroundColor: '#1e3a8a', padding: '20px', display: 'flex', flexDirection: 'column', gap: 4, color: '#fff' },
