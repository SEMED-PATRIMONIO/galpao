...
const db = require('../db'); // Certifique-se de importar o db
...
router.post('/enviar', upload.single('foto'), async (req, res) => {
    ...
    try {
        ...
        await db.query(
            'INSERT INTO historico (contato_nome, contato_email, arquivo_nome, arquivo_tipo) VALUES ($1, $2, $3, $4)',
            [req.body.nome_contato, req.body.para, arquivo.originalname, arquivo.mimetype]
        );
