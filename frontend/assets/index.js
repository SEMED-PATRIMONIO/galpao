...
app.post('/api/v2/presenca/registrar', async (req, res) => {
    ...
    try {
        ...
        // 2. BUSCA EVENTOS ATIVOS EXATAMENTE NO DIA E HORA ATUAL
        ...
        // SE NÃO HOUVER NENHUM EVENTO AGENDADO PARA HOJE/AGORA:
        ...
        // 3. SE EXISTIREM EVENTOS, VALIDA A DISTÂNCIA GEOGRÁFICA
        // [Sua lógica de cálculo de raio/distância continua aqui...]
        
        return res.json({ mensagem: 'Presença processada com sucesso!' });
