...
<head>
    ...
    <title>Dashboard Estratégico - SEMED</title>
    <style>
        :root {
...
<div class="dashboard-grid">
    ...
    <div class="header-main no-print">
        ...
        <div style="display:flex; gap:10px;">
            ...
            <button onclick="abrirModalLimpeza()" style="background:var(--error); border:none;">🗑️ LIMPAR</button>
        </div>
    </div>
    ...
    <div class="card" style="grid-column: span 2;">
        ...
        <div class="scroll-box">
            <table>
                ...
                <tr><td><?php echo $esc['unidade_preferencia']; ?></td><td><span style="background:rgba(255,255,255,0.1); padding:2px 8px; border-radius:5px;"><?php echo $esc['qtd']; ?></span></td></tr>
                <?php endforeach; ?>
            </table>
        </div>
    </div>
