...
<body>
    ...
    <div id="modalBoasVindas" class="modal-overlay">
        <div class="glass-panel" style="max-width: 500px; text-align: center;">
            ...
            <h2 style="border: none;">Seja bem-vindo(a)!</h2>
            <div style="text-align: justify; line-height: 1.6; font-size: 0.95rem; margin-bottom: 20px;">
                <p>Atualmente, o município conta com 18 mil vagas distribuídas em toda a rede. Esta consulta pública visa mapear a necessidade real de cada região, ajudando a Secretaria de Educação a planejar a abertura de turmas e a expansão das escolas de forma precisa.</p>
                
                <p style="background: rgba(231, 76, 60, 0.2); padding: 10px; border-radius: 10px; border-left: 4px solid var(--error);">
                    <strong>⚠️ Importante:</strong> Este formulário é um levantamento de dados para planejamento e <strong>não garante a matrícula escolar</strong>.
                </p>

                <p>Sua participação é essencial para organizarmos o ensino de acordo com a realidade das famílias!</p>
            </div>
            <button type="button" class="btn-avancar" onclick="fecharBoasVindas()">AVANÇAR</button>
        </div>
    </div>
    ...
    <form id="formPrincipal">
        <div class="glass-panel">
            ...
            <div class="step" id="step4">
                ...
                <select name="user_motivo_matricula" id="motivo_matricula" disabled required>
            ...
            <div class="step" id="step7">
                ...
                <input type="text" id="cep" name="cep" maxlength="9" placeholder="00000-000" oninput="maskCEP(this); processarCEP(this)">
    ...
    <script>
        ...
        async function enviarFormulario() {
            ...
            // Adiciona manualmente os campos de endereço e localização
