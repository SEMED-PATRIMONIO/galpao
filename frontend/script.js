...
async function telaSolicitarUniforme() {
    ...
    try {
        ...
        container.innerHTML = `
            <div class="painel-vidro" style="max-width: 1200px; margin: auto; padding: 20px;">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div style="background:rgba(255,255,255,0.1); padding:20px; border-radius:10px; color:white;">
                        ...
                        <select id="solicitar_tamanho" class="input-vidro" style="width:100%; margin-bottom:15px;"></select>
                        ...
                        <button onclick="adicionarAoCarrinhoSolicitacao()" class="btn-vidro" style="width:100%; background:#10b981;">➕ ADICIONAR À LISTA</button>
                    </div>

                    <div style="background:rgba(255,255,255,0.1); padding:20px; border-radius:10px; color:white;">
                        <h3 style="margin-top:0;">Itens na Solicitação</h3>
                        <div id="lista_carrinho_solicitacao" style="min-height:100px;">Nenhum item adicionado ainda.</div>
                        <hr style="border:0; border-top:1px solid rgba(255,255,255,0.1); margin:20px 0;">
                        <button id="btnEnviarSolicitacao" onclick="enviarPedidoEscola('SOLICITACAO')" disabled class="btn-vidro" style="width:100%; background:#1e40af; opacity:0.5;">🚀 ENVIAR SOLICITAÇÃO COMPLETA</button>
                    </div>
                </div>
            </div>
        `;
